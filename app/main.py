...
if user_input:
    ...
    with st.chat_message("assistant"):
        ...
        try:
            ...
            chat_history_for_context = st.session_state.chat_history[:-1]  # Exclude current question
            
            response = llm_manager.generate_response(
                user_input,
                relevant_docs,
                chat_history_for_context[-st.session_state.max_history:],  # Limit history length
